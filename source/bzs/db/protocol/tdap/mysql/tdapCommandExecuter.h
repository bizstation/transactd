...
class dbExecuter : public engine::mysql::dbManager
{
    ...
    inline void doSeekKey(request& req, int op, bool lock);
    inline void doMoveFirst(request& req, bool lock);
    inline void doMoveKey(request& req, int op, bool lock);
    ...
    inline void doStepRead(request& req, int op, bool lock);
