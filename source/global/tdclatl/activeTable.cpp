...
STDMETHODIMP CActiveTable::KeyValue(VARIANT Value0, VARIANT Value1, VARIANT Value2
					...
					, VARIANT Value6, VARIANT Value7, IActiveTable** retVal)
{
	...
	{
		m_at->keyValue(Value0.bstrVal, Value1.bstrVal, Value2.bstrVal, Value3.bstrVal);
		setResult(retVal);
		return S_OK;
	}
	...
	{
		m_at->keyValue(Value0.bstrVal, Value1.bstrVal, Value2.bstrVal, Value3.bstrVal, Value4.bstrVal);
		setResult(retVal);
		return S_OK;
	}
	...
	{
		m_at->keyValue(Value0.bstrVal, Value1.bstrVal, Value2.bstrVal, Value3.bstrVal, Value4.bstrVal
			, Value5.bstrVal, Value6.bstrVal);
		setResult(retVal);
		return S_OK; 
	}
	m_at->keyValue(Value0.bstrVal, Value1.bstrVal, Value2.bstrVal, Value3.bstrVal, Value4.bstrVal
			, Value5.bstrVal, Value6.bstrVal, Value7.bstrVal);
	setResult(retVal);
	return S_OK;
...
STDMETHODIMP CActiveTable::Read(IQueryBase* query, IRecordset** retVal)
{
	...
	if (query)
	{
		...
		if (p && q)
		{
			if (!Name1 || !Name1[0])
				...
				m_at->join(*p->m_rs, *q, Name0,  Name1,  Name2, Name3, Name4, Name5);	
			else if (!Name7 || !Name7[0]) 
				m_at->join(*p->m_rs, *q, Name0,  Name1,  Name2, Name3, Name4, Name5, Name6);
			else
...
STDMETHODIMP CActiveTable::OuterJoin(IRecordset* rs, IQueryBase* query, BSTR Name0
					,BSTR Name1, BSTR Name2, BSTR Name3, BSTR Name4
					,BSTR Name5, BSTR Name6, BSTR Name7
					,IRecordset** retVal)
{
	if (query)
	{
		...
		if (p && q)
		{
			if (!Name1 || !Name1[0]) 
				...
				m_at->outerJoin(*p->m_rs, *q, Name0,  Name1,  Name2, Name3, Name4, Name5);	
			else if (!Name7 || !Name7[0]) 
				m_at->outerJoin(*p->m_rs, *q, Name0,  Name1,  Name2, Name3, Name4, Name5, Name6);
			else
				m_at->outerJoin(*p->m_rs, *q, Name0,  Name1,  Name2, Name3, Name4, Name5, Name6, Name7);
		}
	}
	*retVal = rs;
	return S_OK;
...
STDMETHODIMP CActiveTable::GetWriteableRecord(IWritableRecord** retVal)
{
