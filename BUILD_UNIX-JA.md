...
```
cd ~
wget http://www.bizstation.jp/al/transactd/download/transactd-3.7.3/transactd-source-3.7.3.zip
#Mac OS Xでは
#curl -O http://www.bizstation.jp/al/transactd/download/transactd-3.7.3/transactd-source-3.7.3.zip
unzip -q transactd-source-3.7.3.zip -d transactd
...
wget http://www.bizstation.jp/al/transactd/download/transactd-3.7.3/transactd-source-3.7.3.zip
#Mac OS Xでは
#curl curl -O http://www.bizstation.jp/al/transactd/download/transactd-3.7.3/transactd-source-3.7.3.zip
unzip -q transactd-source-3.7.3.zip -d transactd
```
