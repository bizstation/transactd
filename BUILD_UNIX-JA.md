...
```
cd ~
wget http://www.bizstation.jp/al/transactd/download/transactd-3.8.2/transactd-source-3.8.2.zip
#Mac OS Xでは
#curl -O http://www.bizstation.jp/al/transactd/download/transactd-3.8.2/transactd-source-3.8.2.zip
unzip -q transactd-source-3.8.2.zip -d transactd
...
wget http://www.bizstation.jp/al/transactd/download/transactd-3.8.2/transactd-source-3.8.2.zip
#Mac OS Xでは
#curl curl -O http://www.bizstation.jp/al/transactd/download/transactd-3.8.2/transactd-source-3.8.2.zip
unzip -q transactd-source-3.8.2.zip -d transactd
```
