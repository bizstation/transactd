...
```
cd ~
wget http://www.bizstation.jp/al/transactd/download/transactd-3.6.0/transactd-source-3.6.0.zip
#Mac OS Xでは
#curl -O http://www.bizstation.jp/al/transactd/download/transactd-3.6.0/transactd-source-3.6.0.zip
unzip -q transactd-source-3.6.0.zip -d transactd
...
wget http://www.bizstation.jp/al/transactd/download/transactd-3.6.0/transactd-source-3.6.0.zip
#Mac OS Xでは
#curl curl -O http://www.bizstation.jp/al/transactd/download/transactd-3.6.0/transactd-source-3.6.0.zip
unzip -q transactd-source-3.6.0.zip -d transactd
```
