リリースノート
================================================================================
Version 3.8.1 2018/04/10
================================================================================
修正と変更点
--------------------------------------------------------------------------------
* レコードのInsert時オートインクリメント値の扱いの問題を修正しました。

* クラインとのTCP接続のタイムアウト用のタイマーが応答しない問題を修正しました。
...
修正と変更点
--------------------------------------------------------------------------------
* フルスキャンのクエリーで無効な結果が返る問題を修正しました。

* Pervasive互換のテーブル生成メソッドでプライマリキー定義が初期化されない不具合
  を修正しました。
...
* [C++] `fielddefs::append(const fielddefs* fds)` メソッドを追加しました。
