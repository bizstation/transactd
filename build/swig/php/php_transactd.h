...
ZEND_NAMED_FUNCTION(_wrap_getBtrvEntryPoint);
ZEND_NAMED_FUNCTION(_wrap_setTrnsctdEntryPoint);
ZEND_NAMED_FUNCTION(_wrap_getTrnsctdEntryPoint);
...
ZEND_NAMED_FUNCTION(_wrap_host);
ZEND_NAMED_FUNCTION(_wrap_dbname);
ZEND_NAMED_FUNCTION(_wrap_schemaTable);
